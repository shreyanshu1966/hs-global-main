...
const NotFound = () => {
  ...
  return (
    <div className="bg-[#FFFFFF] text-gray-900 min-h-[80vh] flex items-center justify-center">
      <Helmet>
      ...
      >
        ...
        >
          ...
          <p className="text-lg text-gray-500 max-w-lg mx-auto leading-relaxed">
            {t('404.description', 'The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.')}
          </p>
        </motion.div>
        ...
        >
          <h3 className="text-lg font-semibold text-gray-700 mb-4">
            {t('404.suggestedPages', 'You might be looking for:')}
          </h3>
        ...
        >
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <p className="text-sm text-gray-600">
              {t('404.searchSuggestion', 'Can\'t find what you\'re looking for? Try searching our products or contact us for assistance.')}
            </p>
          </div>
        </motion.div>
      </motion.div>
