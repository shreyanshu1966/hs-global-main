...
const About = () => {
  ...
  useEffect(() => {
    ...
    criticalImages.forEach((filename) => {
      const url = getRootImageUrl(filename);
      if (url) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[85vh] bg-primary overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('${getRootImageUrl("about-hero.webp") || "/about-hero.webp"}')`,
          }}
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                ...
                <img src={getRootImageUrl("export.webp") || "/export.webp"} alt="Global Export" className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700" />
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1 space-y-6 sm:space-y-8">
              ...
              >
                ...
                <img src={getRootImageUrl("marble-solutions.webp") || "/marble-solutions.webp"} alt="Marble Solutions" className="w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] object-cover rounded-xl sm:rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300" />
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              <div
                ...
                style={{ backgroundImage: `url('${getRootImageUrl("granite-solutions.webp") || "/granite-solutions.webp"}')` }}
              />
            </div>
          </div>
        </div>
