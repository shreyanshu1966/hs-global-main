/**
 * Upload the new Banner3 desktop + mobile artwork to Cloudinary,
 * overwriting the existing hs-global/hero/Banner3-des(.webp) / Banner3-mob(.webp) assets.
 *
 * Source: frontend-new/public/Banner3-des_new.png, Banner3-mob_new.png
 */
...
const CONFIG = {
    ...
    outputFile: path.join(__dirname, '../hero-banner3-cloudinary-urls.json'),
    cloudinary: {
    ...
    // sourceFile -> Cloudinary public_id (same public_id as the existing live Banner3 assets, so overwrite: true replaces them)
    files: [
        { source: 'Banner3-des_new.png', publicId: 'Banner3-des', maxWidth: 1920 },
        { source: 'Banner3-mob_new.png', publicId: 'Banner3-mob', maxWidth: 1122 },
    ],
    quality: 85,
};
...
async function main() {
    ...
    console.log('🚀 BANNER 3 (NEW ARTWORK) - CLOUDINARY UPLOAD');
    console.log('='.repeat(60) + '\n');
