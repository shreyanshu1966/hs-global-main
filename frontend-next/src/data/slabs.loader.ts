...
// Manifest of Collection paths (replaces Vite glob; only keys are used)
import fileModulesJson from './_glob-collection.json';
const fileModules = fileModulesJson as unknown as Record<string, () => Promise<FileUrl>>;
