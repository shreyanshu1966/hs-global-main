...
const BlogDetail = ({ initialData }: { initialData?: { blog?: Blog; relatedBlogs?: Blog[] } } = {}) => {
    const { slug } = useParams<{ slug: string }>();
    const [blog, setBlog] = useState<Blog | null>(initialData?.blog ?? null);
    const [relatedBlogs, setRelatedBlogs] = useState<Blog[]>(initialData?.relatedBlogs ?? []);
    const [loading, setLoading] = useState(initialData?.blog ? false : true);
