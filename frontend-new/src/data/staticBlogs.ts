...
export const STATIC_BLOGS: Blog[] = [
  ...
  {
    _id: 'static-handcrafted-furniture-guide',
    title: 'Handcrafted Furniture: The Complete Guide to Timeless Artisan Pieces for Your Home',
    slug: 'handcrafted-furniture-guide',
    excerpt:
    ...
    content: 'Read the full guide on its dedicated page.',
    author: { name: 'HS Global Export', avatar: '' },
    featuredImage: '/blog/handcrafted-furniture-guide/handcrafted-teak-dining-table.jpg',
    ...
    readTime: 10,
    seo: {
      metaTitle: 'Handcrafted Furniture Guide: Artisan, Handmade & Custom Wood Pieces',
      metaDescription:
        'Discover the beauty of handcrafted furniture. Learn how to choose, care for, and buy quality handmade wooden furniture for every room.',
      keywords: [
        'handcrafted furniture',
