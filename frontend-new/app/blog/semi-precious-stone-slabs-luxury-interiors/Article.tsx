        ...
        <div className="flex flex-col gap-5 border-y border-[#ece9dd] py-8 sm:flex-row sm:items-center">
          ...
          <div>
            ...
            <p className="mt-1 text-[14px] font-light leading-[1.6] text-[#555]">
              Premium semi precious stone slabs &amp; natural stone manufacturer and worldwide exporter — serving the USA, UK, Europe and the
              Middle East with spectacular architectural gemstone surfaces.
            </p>
          </div>
        </div>
